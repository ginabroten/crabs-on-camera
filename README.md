...
Code and pipeline for detecting brown crabs (*Cancer pagurus*) in underwater video, developed from the methods in my master's thesis. The goal isn't to push machine learning forward, it's to make these methods approachable for marine scientists working in fisheries applications. 
